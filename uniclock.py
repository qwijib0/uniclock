...
myTinyFont = ImageFont.load('./pixelfive.pil')
...
def sparkle(numloops, frdelay):
    ...
    while (i < numloops):
        ...
        for frame in frames:
            ...
            i1.text((37,51), str(day_str), font=myTinyFont, fill=(255, 255, 255))
            i1.text((48,45), str(dow_str), font=myTinyFont, fill=(255, 255, 255))
